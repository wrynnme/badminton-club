...
>
> **ยังไม่ทำ (A ที่เหลือ):** auto-rotate-all-courts (A1, สร้างทีละสนามด้วยปุ่ม), not_ready_action wiring (A3, UI hint), game_time_limit enforcement (A4, UI hint), Realtime (A5, manual refresh).
>
