...
1. **ผูกก๊วน/ผู้เล่นครั้งเดียวใช้ได้ตลอด (persistent link)** — 📐 **DESIGNED + GRILLED ✅ 2026-07-15, user เลือกทาง C เต็มรูป (ก๊วนถาวร + นัด); decisions ล็อกครบ 15 ข้อ** (ดู "### 📐 Design — ผูกครั้งเดียวใช้ได้ตลอด" ด้านล่าง); EXPAND + backfill **APPLIED prod**; **P1 (webhook/บิล/join resolve ผ่าน series) IMPLEMENTED บนแบรนช์ `feat/club-series-p1-line-resolve` 2026-07-15 — ยังไม่ commit/merge/deploy** (รายละเอียดเต็มใน § "Migration prod" ข้อ 3 ด้านล่าง); ขั้นถัดไป = review+commit P1 แล้วต่อ P2.
